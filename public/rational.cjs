 ...
 * it must export its functions to serve {@link https://expressjs.com Express},
 * which provides a robust set of features for web and mobile applications.</p>
 *
 * @author Paulo Roma
 * @since 24/10/2023
 ...
 * @see <a href="../PDFs/mod. vi - anal. econ.financ.e invest.pdf">Avaliação Financeira</a>
 */
 ...
 * @see <a href="../PDFs/matematica_financeira.pdf#page=6">Parcelas</a>
 * @see <img src="../PDFs/coeficiente-de-financiamento.png" width="256">
 */
function CF(i, n) {
  return i / (1 - (1 + i) ** -n);
}
